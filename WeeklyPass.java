/**
 * Class representing a weekly parking pass.
 */
public class WeeklyPass implements Pass {
    ...
    public WeeklyPass(int id, int vehicleId, double fees, String issueDate, String expiryDate) {
        this.id = id;
    ...
    public void createPass(int id, int vehicleId, double fees, String issueDate, String expiryDate) {
        ...
        this.issueDate = issueDate;
        this.expiryDate = expiryDate;
        System.out.println("Weekly Pass created successfully.");
        getPass(id);
    }
